...
Define the long-term memory system for the Custom ChatGPT app, including backend CRUD API, LLM-based memory extraction, system prompt injection, manual and automatic extraction triggers, the memory management UI, and per-user memory limits.
